...
\begin{titlepage}
\begin{center}
{\bfseries \TODO{Համալսարանի անվանումը}}\\[0.3cm]
{\bfseries \TODO{Ֆակուլտետի անվանումը}}\\[0.3cm]
{\bfseries \TODO{Ամբիոնի անվանումը}}\\[2.0cm]

{\bfseries ԲԱԿԱԼԱՎՐԻ ԱՎԱՐՏԱԿԱՆ ԱՇԽԱՏԱՆՔ}\\[1.5cm]

{\bfseries Թեմա՝}\\[0.4cm]
{\bfseries \large \Eng{AI Image Manipulation} համակարգի նախագծում և իրականացում}\\[2.0cm]

\begin{tabular}{>{\bfseries}p{5cm}p{8cm}}
Ուսանող՝ & Սպարտակ Աղաբաբյան \\
Մասնագիտություն՝ & \TODO{մասնագիտությունը} \\
Ղեկավար՝ & \TODO{ղեկավարի անունը, գիտական աստիճանը} \\
\end{tabular}

\vfill
{\bfseries \TODO{Քաղաք} -- 2026}
\end{center}
\end{titlepage}
...
Այս աշխատանքը նվիրված է \Eng{AI Image Manipulation} համակարգի նախագծմանը և իրականացմանը։ Աշխատանքի հիմքում ընկած է այն գաղափարը, որ image editing-ը կարելի է ներկայացնել ոչ միայն որպես pixels-ի անմիջական գեներացում, այլ նաև որպես գործողությունների հաջորդականություն, որտեղ մոդելը տեսնում է ներկա canvas-ը, ստանում է natural language instruction, ապա վերադարձնում է structured JSON action sequence։ Նման մոտեցումը թույլ է տալիս image manipulation task-ը մոտեցնել \Eng{vision-language-action} խնդրին, որտեղ output-ը ոչ թե անմիջապես վերջնական պատկերն է, այլ վերահսկելի և վերարտադրելի edit operations-ի շարք։

Աշխատանքում նախագծվել է data annotation tool, որը թույլ է տալիս օգտատիրոջը կատարել brush, pencil, eraser, fill, picker, color adjustment, text overlay, blur, clone stamp, scatter brush, pattern brush և forward warp գործողություններ։ Յուրաքանչյուր գործողություն գրանցվում է session log-ում, իսկ canvas-ի միջանկյալ վիճակները պահպանվում են որպես frames։ Այնուհետև մշակվել է data preparation pipeline, որը raw operations-ը խմբավորում է strokes-ի, compress է անում trajectory-ները \Eng{Ramer--Douglas--Peucker} algorithm-ի միջոցով, բաժանում է տվյալները fixed-horizon action chunks-ի և ձևավորում է \Eng{HuggingFace Dataset}՝ model fine-tuning-ի համար։

Մոդելավորման մասում ներկայացվում է \Eng{Qwen/Qwen3.5-4B} vision-language model-ի վրա հիմնված training approach, որտեղ օգտագործվում է \Eng{QLoRA} supervised fine-tuning և reward-based \Eng{GRPO} training։ Համակարգի inference փուլը կառուցված է observe--predict--execute--reobserve loop-ի վրա․ մոդելը կանխատեսում է action chunk, deterministic canvas executor-ը կիրառում է գործողությունները, ապա ստացված canvas-ը կրկին տրվում է մոդելին մինչև completion կամ սահմանված iteration limit։

Աշխատանքի ելակետն այն է, որ ժամանակակից image generation model-ները արդեն լավ են լուծում ամբողջական image generation խնդիրը, ուստի ավելի հետաքրքիր է կառուցել controlled editing layer existing image-ի վրա։ Արդյունքը research prototype է, որը միավորում է annotation, data processing, action schema validation, deterministic rendering, supervised training, reward-based optimization և inference pipeline components։ Աշխատանքը ցույց է տալիս, որ image editing task-ը կարելի է ձևակերպել որպես controllable tool-based action generation problem, ինչը ավելի թափանցիկ և վերլուծելի մոտեցում է՝ համեմատած ամբողջական image-to-image black-box generation-ի հետ։
...
Այսօր image generation model-ները արդեն հասել են այնպիսի որակի, որ այս աշխատանքի շրջանակում 0-ից general-purpose image generation model կառուցելը նպատակահարմար չէ։ Խնդիրը ոչ թե նոր text-to-image generator ստեղծելն է, այլ ուսումնասիրելը, թե ինչպես կարելի է existing image-ի վրա կատարել controlled, local և interpretable փոփոխություններ՝ առանց ամբողջ image-ը անտեղի վերագեներացնելու։

Դասական image generation կամ image-to-image editing մոտեցումների հիմնական սահմանափակումներից մեկն այն է, որ natural language instruction ստանալիս model-ը հաճախ փոփոխում է ոչ միայն խնդրված հատվածը, այլև image-ի այլ մասերը։ Օրինակ, եթե օգտատերը խնդրում է blur անել logo-ն, նկարել moustache կամ փոխել միայն փոքր region-ի գույնը, model-ը կարող է միաժամանակ փոխել lighting-ը, background-ը, texture-ը կամ object identity-ն։ Այդ պատճառով այս աշխատանքում շեշտը դրվում է ոչ թե final image-ի անմիջական generation-ի, այլ edit process-ի վերահսկելի ներկայացման վրա։

Առաջարկվող ուղղությունը նորարարական է այն իմաստով, որ image manipulation-ը ձևակերպվում է որպես tool-based action generation problem։ Model-ը չի վերադարձնում միայն վերջնական image, այլ կանխատեսում է executable actions՝ օրինակ pencil, brush, eraser, fill, gaussian blur, clone stamp, text overlay կամ forward warp։ Այսպիսով համակարգը փորձում է գործել designer-ի նման․ այն «ընտրում է» գործիք, որոշում է location-ը, size-ը, color-ը և հաջորդական քայլերով փոփոխում է canvas-ը։ Հեղինակի ուսումնասիրած open-source և academic նյութերի շրջանակում նման explicit tool-action workflow-ը դեռ լայնորեն տարածված չէ, ինչն էլ աշխատանքին տալիս է research prototype-ի նշանակություն։

Այս ձևակերպումը նաև թույլ է տալիս model output-ը դարձնել ստուգելի և կրկնելի։ Եթե գործողությունները ներկայացվում են structured JSON ձևաչափով, ապա system-ը կարող է validate անել դրանք, deterministic կերպով execute անել, պահպանել session history-ն և վերլուծել սխալները։ Սա է աշխատանքի հիմնական գաղափարը՝ image manipulation-ը դիտարկել ոչ թե որպես single black-box generation step, այլ որպես designer-like sequential editing process։

\section*{Աշխատանքի արդիականությունը}
\addcontentsline{toc}{section}{Աշխատանքի արդիականությունը}

Աշխատանքի արդիականությունը պայմանավորված է երեք հիմնական հանգամանքով։ Առաջինը՝ ժամանակակից image editing համակարգերում կա աճող պահանջ controlled և interpretable editing-ի նկատմամբ։ Օգտատերերը հաճախ ցանկանում են ոչ թե ամբողջ image-ի style transfer կամ regeneration, այլ որոշակի semantic edit, որը պետք է լինի local, explainable և կրկնելի։ Երկրորդը՝ \Eng{vision-language models}-ի զարգացումը հնարավորություն է տալիս natural language instruction-ը կապել visual context-ի հետ, սակայն անհրաժեշտ է պարզել, թե ինչպես կարելի է այդ կապը վերածել concrete editing actions-ի։ Երրորդը՝ training data-ի հավաքումը image manipulation-ի համար բարդ է, քանի որ միայն before/after image pair-ը հաճախ չի բացատրում, թե ինչ գործողություններ են իրականացվել։ Այս աշխատանքում առաջարկվող annotation-and-action-logging մոտեցումը լուծում է այդ խնդրի մի մասը՝ պահպանելով ոչ միայն final result-ը, այլ նաև edit process-ը։
...
Image manipulation-ը ներառում է այնպիսի գործողություններ, որոնց միջոցով գոյություն ունեցող image-ը փոփոխվում է ըստ օգտատիրոջ նպատակի։ Այդ փոփոխությունները կարող են լինել local կամ global։ Local գործողությունների օրինակներ են՝ object-ի վրա moustache նկարելը, logo blur անելը, face-ի որոշ հատվածը deform անելը կամ որոշակի հատվածում text ավելացնելը։ Global գործողությունների օրինակներ են՝ ամբողջ image-ի brightness, contrast, saturation կամ color tone փոփոխելը։

Դասական image editing համակարգերում այս գործողությունները կատարվում են explicit tools-ով։ Օգտատերը ընտրում է brush, eraser, clone stamp, blur tool կամ color adjustment parameter, և յուրաքանչյուր քայլ անմիջապես փոխում է canvas-ը։ \Eng{AI}-ի վրա հիմնված systems-ում, հակառակը, հաճախ օգտագործվում է instruction-to-image կամ image-to-image մոտեցում, որտեղ մոդելը սովորում է վերջնական image distribution-ը։ Այդ մոտեցումը կարող է տալ բարձր որակի արդյունքներ, սակայն այն միշտ չէ, որ ապահովում է ամբողջական control։

Այս աշխատանքի համար կարևոր է հետևյալ դիտարկումը․ եթե image editing-ը ներկայացվում է որպես action sequence, ապա ամեն քայլ ունի բացատրելի իմաստ։ Օրինակ՝ հետևյալ JSON-ը արդեն նկարագրում է ոչ թե վերջնական image-ը, այլ այն գործողությունը, որը պետք է կիրառել.
...
Այսպիսի representation-ը կարող է ստուգվել, սահմանափակվել canvas-ի չափերով, պահվել որպես training target և deterministic կերպով վերարտադրվել։

\section{Action-based editing մոտեցման առավելությունները}

Action-based editing մոտեցումը ունի մի քանի կարևոր առավելություն։ Նախ, այն դարձնում է model output-ը structured։ Փոխանակ մոդելը արտադրի arbitrary text կամ image, այն պետք է վերադարձնի valid JSON, որտեղ յուրաքանչյուր action ունի action type և համապատասխան parameters։ Սա թույլ է տալիս օգտագործել validation layer, որը սխալ կամ վտանգավոր output-ը կարող է մերժել կամ փոխարինել noop action-ով։

Երկրորդ, action-based մոտեցումը պահպանում է edit trace-ը։ Եթե վերջնական result-ը լավ չէ, հնարավոր է տեսնել, թե որ action-ն է սխալ եղել՝ սխալ color, սխալ point, սխալ brush size կամ սխալ tool selection։ Սա մեծ առավելություն է research prototype-ի համար, որովհետև համակարգը ավելի հեշտ է debug անել։

Երրորդ, action sequence-ը մոտեցնում է model-ի աշխատանքը մարդու editing process-ին։ Մարդը image editor-ում նույնպես աշխատում է գործիքներով և քայլերով։ Այս similarity-ն հնարավորություն է տալիս data collection-ը կազմակերպել user demonstrations-ի միջոցով։ Այս աշխատանքի annotation tool-ը հենց այդ նպատակն ունի․ այն գրանցում է user-ի գործողությունները, որպեսզի դրանք հետագայում օգտագործվեն որպես model training target։
...
Եթե canvas-ը նշանակենք $I_t$, instruction-ը՝ $u$, իսկ model-ը՝ $f_\theta$, ապա model-ի խնդիրը կարելի է գրել հետևյալ կերպ.
\begin{equation}
...
Աշխատանքում օգտագործվում են մի քանի հիմնական գաղափարներ։ \Eng{Ramer--Douglas--Peucker} algorithm-ը կիրառվում է raw stroke trajectory-ների compression-ի համար։ \Eng{LoRA} և \Eng{QLoRA} մոտեցումները կիրառվում են large model fine-tuning-ը resource-efficient դարձնելու համար \cite{Hu2022,Dettmers2023}։ \Eng{Supervised Fine-Tuning} փուլում մոդելը սովորում է ground-truth actions-ը, իսկ reward-based training փուլում գնահատվում է այն, թե generated actions-ը որքանով են մոտեցնում canvas-ը target edit-ին։
...
\Eng{Canvas executor} & Կիրառում է action sequence-ը canvas-ի վրա deterministic կերպով։ \\
...
\Eng{Eraser} & Վերականգնում է original image-ի pixels-ը ընտրված հատվածում։ \\
\Eng{Fill} & Կատարում է flood fill ընտրված point-ից։ \\
\Eng{Picker} & Ընտրում է color-ը canvas-ի pixel-ից։ \\
...
\Eng{Gaussian blur} & Blur է անում image-ը կամ դրա հատվածները։ \\
\Eng{Clone stamp} & Պատճենում է source region-ը destination region-ում։ \\
\Eng{Forward warp} & Deform է անում image-ի հատվածը drag trajectory-ի ուղղությամբ։ \\
...
Schema validation-ը նաև սահմանում է allowed ranges։ Օրինակ՝ color channels-ը սահմանափակվում են $[0,255]$ միջակայքով, coordinates-ը պետք է լինեն canvas-ի սահմաններում, իսկ stroke size-ը չի կարող լինել բացասական կամ շատ մեծ։ Սա կարևոր է, քանի որ model output-ը միշտ չէ, որ կատարյալ valid է։ Validation layer-ը պաշտպանում է executor-ը սխալ input-ից։
...
\begin{tabularx}{\textwidth}{p{3.5cm}X}
\toprule
\textbf{Action type} & \textbf{Հիմնական fields} \\
\midrule
...
Յուրաքանչյուր operation-ը պահպանում է նվազագույն անհրաժեշտ metadata, որպեսզի հետագայում հնարավոր լինի վերականգնել edit process-ը։ Սակայն raw format-ը դեռ training-ready չէ։ Այն պետք է անցնի compression, chunking և formatting փուլերով։
...
Deterministic canvas executor-ը համակարգի այն component-ն է, որը action sequence-ը վերածում է actual image change-ի։ Այն ստանում է canvas-ը որպես NumPy array և sequential կերպով կիրառում է actions-ը։ Executor-ի deterministic լինելը կարևոր է, որովհետև նույն input canvas-ը և նույն action chunk-ը պետք է միշտ տան նույն output canvas-ը։ Սա անհրաժեշտ է ինչպես training target-ի վերարտադրության, այնպես էլ reward calculation-ի համար։

Canvas-ը ներկայացվում է որպես RGB image՝ float32 values $[0,1]$ միջակայքում։ Իսկ OpenCV drawing operations-ի համար անհրաժեշտության դեպքում image-ը փոխարկվում է uint8 format-ի։ Այս conversion-ը սովորական տեխնիկական քայլ է computer vision համակարգերում \cite{GonzalezWoods2018,Szeliski2022}։
...
Այս formula-ն թույլ է տալիս նույն կերպ նկարագրել brush-ի, fill-ի և text-ի rendering-ը։ Տարբերությունը միայն mask-ի կառուցման եղանակն է։ Brush-ի դեպքում mask-ը կախված է stroke segment-ից և hardness-ից, fill-ի դեպքում՝ flood-filled region-ից, իսկ text overlay-ի դեպքում՝ text glyph mask-ից։

\section{Brush և hardness}

Brush action-ը ունի stroke size և hardness parameters։ Hardness-ը որոշում է mask-ի եզրերի softness-ը։ Եթե hardness-ը $100$ է, mask-ը կոշտ է՝ pixel-ը կամ ամբողջությամբ ծածկված է, կամ ոչ։ Եթե hardness-ը փոքր է, mask-ը radial falloff ունի։
...
Eraser action-ը սովորական drawing action չէ։ Այն չի ներկում canvas-ը background color-ով, այլ վերականգնում է original image-ի pixels-ը տվյալ mask-ի ներսում։ Եթե $I_0$-ն original image-ն է, ապա eraser-ի համար
\begin{equation}
    I'(x,y) =
    \begin{cases}
    I_0(x,y), & M(x,y)>0,\\
...
\end{equation}
որտեղ $\gamma$-ն contrast factor-ն է։ Saturation-ի համար image-ը փոխարկվում է HSV color space, և saturation channel-ը բազմապատկվում է համապատասխան coefficient-ով։
...
Noop action-ը հատուկ action է, որը ոչինչ չի փոխում canvas-ի վրա։ Եթե model-ը վերադարձնում է ամբողջությամբ noop actions-ով chunk, inference loop-ը կարող է դա մեկնաբանել որպես completion signal։ Սա կարևոր է, որովհետև system-ը պետք է իմանա, թե երբ դադարեցնել editing process-ը։
...
\Eng{load\_in\_4bit} & True, model-ը բեռնվում է 4-bit quantization-ով։ \\
\Eng{LoRA r} & 16։ \\
\Eng{LoRA alpha} & 32։ \\
\Eng{batch size} & 4՝ gradient accumulation-ի հետ։ \\
\Eng{learning rate} & $10^{-4}$ SFT-ի համար։ \\
...
SFT-ից հետո համակարգը նախատեսում է reward-based training փուլ՝ \Eng{GRPO} trainer-ի միջոցով։ Այս փուլում model-generated actions-ը execute են արվում canvas-ի վրա, այնուհետև resulting canvas-ը համեմատվում է ground-truth next canvas-ի հետ։ Այս մոտեցումը կարևոր է, որովհետև model-ի output-ը կարող է syntactically ճիշտ լինել, բայց visually սխալ։ Reward-ը չափում է final visual effect-ը։

Այս աշխատանքի reward function-ը կենտրոնանում է ground-truth changed region-ի վրա։ Եթե $I$-ն current canvas-ն է, $T$-ն ground-truth target canvas-ը, իսկ $P$-ն predicted actions-ի execute-ից ստացված canvas-ը, ապա ground-truth changed region mask-ը սահմանվում է հետևյալ կերպ.
\begin{equation}
...
\begin{align}
    ...
    \mathrm{accuracy} &= 1 - \frac{1}{|M|}\sum_{(x,y)\in M}\left|P(x,y)-T(x,y)\right|, \\
    \mathrm{spurious} &= \frac{1}{|\overline{M}|}\sum_{(x,y)\notin M}\left|P(x,y)-I(x,y)\right|,
\end{align}
որից ստացվում է վերջնական reward-ը.
\begin{equation}
    r = \mathrm{clamp}\!\left(\mathrm{coverage}\times\mathrm{accuracy} - 0.1\cdot\mathrm{spurious},\;-1,\;1\right).
\end{equation}
Coverage factor-ն ապահովում է, որ noop prediction-ի դեպքում ($\hat{M}=\varnothing$) reward-ը միշտ $\leq 0$ լինի, այսինքն՝ model-ը չի կարող «ոչինչ չանելու» ռազմավարությամբ դրական reward ստանալ։ Accuracy-ն գնահատում է pixel-level ճշտությունը changed region-ի ներսում, իսկ spurious penalty-ն պատժում է changed region-ից դուրս կատարված ավելորդ փոփոխությունները։

\section{Inference loop}

Inference-ի ժամանակ system-ը աշխատում է iterative loop-ով։ Սկզբում input image-ը resize է արվում canvas size-ի, այնուհետև model-ը ստանում է current canvas և instruction։ Model-ը վերադարձնում է action chunk։ Parser-ը փորձում է extract անել balanced JSON object, validate է անում actions-ը, իսկ invalid actions-ը կարող է մերժել։ Valid action chunk-ը փոխանցվում է executor-ին։
...
\midrule
\Eng{Annotation tool} & Օգտատերը կարող է image-ի վրա կատարել տարբեր editing actions, իսկ system-ը պահպանում է frames և JSON logs։ \\
...
\Eng{Canvas executor} & Action chunks-ը deterministic կերպով կիրառվում են NumPy/OpenCV canvas-ի վրա։ \\
...
\begin{itemize}
    ...
    \item image-ը black and white կամ dusk-like դարձնել,
    \item white canvas-ի վրա sun, house, sky/ground/clouds նկարել,
...
Առաջին ուժեղ կողմը interpretability-ն է։ Եթե output image-ը սխալ է, հնարավոր է ուսումնասիրել generated action sequence-ը և հասկանալ սխալի աղբյուրը։ Օրինակ՝ եթե moustache-ը սխալ տեղում է, կարելի է տեսնել, որ start/end coordinates-ը սխալ են։ Եթե color-ը սխալ է, color rgba field-ը կարելի է ստուգել։
...
Երրորդ ուժեղ կողմը reproducibility-ն է։ Նույն action chunk-ը և նույն input canvas-ը միշտ տալիս են նույն output-ը։ Սա կարևոր է ինչպես training-ի, այնպես էլ evaluation-ի համար։
...
Չորրորդ սահմանափակումը վերաբերում է quantitative evaluation-ին։ Վերջնական thesis version-ում ցանկալի է ավելացնել training loss curves, validation loss, generated samples և human evaluation կամ visual reward statistics։ Այս draft-ում numerical results չեն հորինվում, քանի որ դրանք պետք է ստացվեն իրական training run-ից։
...
Ընդհանուր առմամբ, իրականացված աշխատանքը ցույց է տալիս, որ \Eng{AI}-ի միջոցով image manipulation-ը կարելի է կառուցել ոչ թե միայն որպես final image generation, այլ որպես designer-like editing actions-ի կանխատեսում։ Այս մոտեցումը հատկապես կարևոր է այն դեպքերում, երբ անհրաժեշտ է փոխել image-ի փոքր հատվածը և պահպանել մնացած մասերը։ Այն կարող է հիմք ծառայել ավելի բացատրելի, վերահսկելի և user-editable AI image editors-ի համար։
